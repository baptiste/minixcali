...
Edit: I got the [following answers](https://github.com/excalidraw/excalidraw/discussions/2672),

- "boundElementIds" — ids of (linear) elements that are bound to this element
...
To create multiple shapes at once it can be useful to create a data.frame of attributes, and use `purrr` functions to iterate over each row,
